...
/** @type {string} */
const CACHE_VERSION = '1777833309|55558701';
/** @type {string} */
const CACHE_PREFIX = 'Magooster1000's -sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["app.html","app.js","app.offline.html","app.icon.png","app.apple-touch-icon.png","app.audio.worklet.js","app.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["app.wasm","app.pck","app.side.wasm","libcameraserver-extension.web.wasm"];
